...
// Єдина форма звертання для всіх питань і підказок.
const ADDRESS_RULE = `\n\nВАЖЛИВО: звертайся до кандидата виключно на "ти" (неформально, дружньо) — в усіх питаннях і в полі followUp. Ніколи не використовуй форму "ви".`;
